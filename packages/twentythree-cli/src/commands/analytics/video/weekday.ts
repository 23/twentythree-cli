 ...
 */
export default class AnalyticsVideoWeekday extends AuthenticatedCommand<typeof AnalyticsVideoWeekday> {
  ...
  public async run(): Promise<void | object> {
    ...
    const headers = ['Day', 'Plays', 'Engagement', 'Playrate', 'Traffic']
