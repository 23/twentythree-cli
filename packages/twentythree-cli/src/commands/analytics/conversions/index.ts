 ...
 */
export default class AnalyticsConversionsIndex extends AuthenticatedCommand<typeof AnalyticsConversionsIndex> {
  ...
  public async run(): Promise<void | object> {
    ...
    const { data, error } = await this.apiClient.GET('/analytics/data/conversions', {
      params: {
        query: {
