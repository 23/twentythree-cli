...
_See code: [src/commands/webinar/index.ts](https://github.com/23/twentythree-cli/blob/v1.5.0/src/commands/webinar/index.ts)_
...
_See code: [src/commands/webinar/update.ts](https://github.com/23/twentythree-cli/blob/v1.5.0/src/commands/webinar/update.ts)_
...
_See code: [src/commands/webinar/upload-image.ts](https://github.com/23/twentythree-cli/blob/v1.5.0/src/commands/webinar/upload-image.ts)_
