...
_See code: [src/commands/agentic/session/list.ts](https://github.com/23/twentythree-cli/blob/v1.6.2/src/commands/agentic/session/list.ts)_
...
_See code: [src/commands/agentic/session/metrics.ts](https://github.com/23/twentythree-cli/blob/v1.6.2/src/commands/agentic/session/metrics.ts)_
...
_See code: [src/commands/agentic/session/status.ts](https://github.com/23/twentythree-cli/blob/v1.6.2/src/commands/agentic/session/status.ts)_
