...
_See code: [src/commands/video/section/check-generate-available.ts](https://github.com/23/twentythree-cli/blob/v1.6.4/src/commands/video/section/check-generate-available.ts)_
