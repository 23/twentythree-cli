...
_See code: [src/commands/video/section/check-generate-available.ts](https://github.com/23/twentythree-cli/blob/v1.3.5/src/commands/video/section/check-generate-available.ts)_
