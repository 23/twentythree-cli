...
_See code: [src/commands/presentation/setting/list.ts](https://github.com/23/twentythree-cli/blob/v1.3.7/src/commands/presentation/setting/list.ts)_
...
_See code: [src/commands/presentation/setting/update.ts](https://github.com/23/twentythree-cli/blob/v1.3.7/src/commands/presentation/setting/update.ts)_
